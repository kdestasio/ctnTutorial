...
pathToStudyFolder = os.path.join(os.sep, "projects", "sanlab", "shared", "ctnTutorial") # folder that contains pathToBidsFolder and pathToConversionFolder
...
# Test subject
test_subject = "REV055_20150811_135636" # Name of a directory that contains DICOMS for on   e participant. Must be subfolder of pathToDicomsFolder. E.g. pathToDicomsFolder/S001
